...
class PyCoder(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.aiPanel.setVisible(False)  # Initially hidden
    ...
    def projectChanged(self, index):
        ...
        if windowType == "Start":
            ...
            if self.aiPanel.isVisible():
                current_editor = window.editorTabWidget.currentWidget()
                if current_editor:
    ...
    def toggleAIPanel(self):
        ...
        # If we're showing the panel, try to set the current editor
        if not current_visibility:
            ...
            if current_index >= 0:
                ...
                if hasattr(current_window, 'editorTabWidget'):
                    ...
                    current_editor = current_window.editorTabWidget.currentWidget()
                    if current_editor:
                        self.aiPanel.set_editor(current_editor)
